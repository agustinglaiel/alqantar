...
function FutureUpgrade({ 
  ...
  const icons = {
    construction: (
      <svg className="size-full text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    rocket: (
      <svg className="size-full text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              d="M13 10V3L4 14h7v7l9-11h-7z" />
      </svg>
    ),
    sparkles: (
      <svg className="size-full text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
    ...
    clock: (
      <svg className="size-full text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    ),
    heart: (
      <svg className="size-full text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
      </svg>
    ),
    gear: (
      <svg className="size-full text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center ${currentSize.container} ${className}`}>
      ...
      <div className="flex space-x-2">
        <div 
          className={`${currentSize.dots} animate-pulse rounded-full bg-blue-400`}
          style={{ animationDelay: '0ms', animationDuration: '1.5s' }}
        />
        <div 
          className={`${currentSize.dots} animate-pulse rounded-full bg-purple-400`}
          style={{ animationDelay: '300ms', animationDuration: '1.5s' }}
        />
        <div 
          className={`${currentSize.dots} animate-pulse rounded-full bg-green-400`}
